...
<body class="text-break text-center"
    style="background: url('../../../images///Giving/ Tuesday.jpg');background-size: cover; overflow-x: hidden; "
    data-bs-spy="scroll">
    <div>
        <div class="row">
                    ...
                    <div class="container" style="margin-top: 12%;">
                        ...
                        <div class="row d-flex justify-content-center"
                            ...
                            <div class="col" style="color: white;">
                                ...
                                <h1>Supervisor <span style='font-size:50px;'>&#128524;</span>
</h1> 

<span style='font-size:50px;'>&#128186;</span>
                                <p class="fs-5">Life is easy if you take it easily <span style='font-size:20px;'>&#127793;</span> <br>
                            ...
                            <div class="col-md-6 col-xl-4 text-center" style="margin-left: 275px;margin-right: 250px;">
                                <div class="card mb-5" style="background-color: hotpink;0, 0, 0, 0.5;">
                                    <div class="card-body d-flex flex-column align-items-center"
                                        ...
                                        <form action="../../../Controller/Supervisor/Login_Handler.php"
                                            ...
                                            <label class="form-check-label" style="color: black;">Didn't have
